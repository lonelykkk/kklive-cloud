package com.kklive.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_PREFIX = "kklive:";
    ...
    public static final String SERVER_NAME_ADMIN = "kklive-cloud-admin";

    public static final String SERVER_NAME_WEB = "kklive-cloud-web";

    public static final String SERVER_NAME_INTERACT = "kklive-cloud-interact";

    public static final String SERVER_NAME_RESOURCE = "kklive-cloud-resource";
